...
public class InvoiceTest {
    ...
    public void testGetId() {
        ...
        Invoice instance = new Invoice(1, 1, 1, "Test", 1,2.0);
        int expResult = 1;
    ...
    public void testSetDeliveryFee() {
        ...
        Invoice instance = new Invoice(1, 1, 1, "Test", 1,2.0);
        instance.setTotalPrice(deliveryFee);
    ...
    public void testToString() {
        ...
        Invoice instance = new Invoice(1, 1, 1, "Test", 1,2.0);
        String expResult = "Invoice{id=1, orderId=1, pharmacyId=1, clientEmail=Test, totalPrice=1.0, deliveryFee=2.0}";
    ...
    public void testEquals() {
        ...
        result = instance.equals(new Invoice(2, 1, 1, "Test", 1,2.0));
        assertEquals(false, result);

        result = instance.equals(new Invoice(1, 2, 3, "Test2", 4,2.0));
