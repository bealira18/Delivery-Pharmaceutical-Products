...
public class GraphAlgorithmsTest {
    ...
    public void testGetNearestPharmacy() {
        ...
        Address result = GraphAlgorithms.getNearestPharmacy(true, g, aOrig, lad);
        assertEquals(expResult, result);
    }
    ...
    public void testGetNearestPharmacy2() {
        ...
        Address result = GraphAlgorithms.getNearestPharmacy(true, null, aOrig, lad);
        assertEquals(expResult, result);
    }
    ...
    public void testGetNearestPharmacy4() {
        ...
        Address expResult = null;
        Address result = GraphAlgorithms.getNearestPharmacy(true, null, aOrig, new ArrayList<>());
        assertEquals(expResult, result);
    }
    ...
    @Test
    public void testGetNearestPharmacy7() {
        ...
        Address a10 = new Address("pavilhao rosa mota", 41.148333, 8.625278, 72);
        Address a11 = new Address("estadio do bessa", 41.162222, 8.643333, 66);
        Address a12 = new Address("gaia shopping", 41.11, 8.623611, 89);
        Address a13 = new Address("ponte da arrabida", 41.147222, 8.64, 66);
        ...
        Path p19 = new Path(a3, a4, 0, 90, 12);
        Path p20 = new Path(a4, a5, 0, 90, 12);
        Path p21 = new Path(a8, a12, 0, 90, 12);
        Path p22 = new Path(a12, a8, 0, 90, 12);
        Path p23 = new Path(a12, a13, 0, 90, 12);
        Path p24 = new Path(a13, a12, 0, 90, 12);
        Path p25 = new Path(a1, a13, 0, 90, 12);
        Path p26 = new Path(a13, a1, 0, 90, 12);
        Path p27 = new Path(a7, a8, 0, 90, 12);
        ...
        Address expResult = a12;
        Address result = GraphAlgorithms.getNearestPharmacy(false, g, aOrig, lad);
        assertEquals(expResult, result);
    }
